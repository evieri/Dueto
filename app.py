...
def gerar_recomendacoes_alternativas(artistas_ids, generos_artistas):
    recomendacoes = []
    for artista_id in artistas_ids[:2]: # Limita a 2 artistas para ser mais rápido
        try:
    ...
    if not dados_albuns_a or not dados_albuns_b:
        ...
        with st.spinner("Analisando..."):
            ...
            if not recomendacoes_unicas:
                ...
                # ===================================================================
                #               CORREÇÃO: BLOCO DO BANCO DE DADOS AQUI
                # ===================================================================
                # O código abaixo é executado DEPOIS de gerar as recomendações,
                # mas ANTES de mostrá-las na tela.
                try:
